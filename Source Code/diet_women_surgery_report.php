...
<link rel="stylesheet" href="css/women_surgery_report.css"/>	
</head>
...
<body>
    ...
    <header class="head">
       ...
       <div class="div4" >
            ...
            <div class="div3">
         		<h1 class="title"><span>تغذية مرضى قسم نساء (جراحة)</span></h1>
	...
	<form method="post">
		...
		if(isset($_SESSION['username']))
			...
			$row1=mysqli_fetch_assoc($queryResult1);
				  ...
				  if($row1[to_dept] == 2 && $row1[to_ward] == 2)
				  {
				  ...
				  else if ($row[ward] == 2 && $row[ademission_dept] == 2){
	...
	<script src="js/women_surgery_report.js"></script>
</body>
</html>