...
<meta name="viewport" content="width=device-width, initial-scale=1"> 
    ...
    <link rel="stylesheet" href="css/edit-f-styles/cbc-edit-style.css"/>
    <!--link rel="stylesheet" href="css/lab-type.css"/-->
   
    <title> Edit CBC Report</title>  
    <!--[if lt IE 9]>
    ...
    <body>
        <div class="container g">
            ...
            <form id="form1" method="post" action="d-r-cbc.php">
                <div class="row ">
                    
                    <div class="col-sm-1">
                        <button class="btn btn-primary btn-lg print back_but" name="back" id="back_d_cbc" data-toggle='tooltip' title='رجوع'   >
                            <span class='glyphicon glyphicon-arrow-left sp_back' id='s3'></span> 
                        </button>
                    </div>
                    
                        <h1 class="col-sm-11 general_lab_title" > تعديل نتائج </h1>
...
{	
    ...
    $sql4="SELECT * FROM seci.lab1_cbc where Serial ='" . $_SESSION['serial']. "' ";
...
print "
    ...
    <!----------------------- -:(patient date):- ------------------------->
        ...
        <div class='row b-space'>
            ...
            <div class='col-sm-1'>
                <button type='submit' class='btn btn-primary btn-lg print' name='insert' id='insert ed-cbc' data-toggle='tooltip' title='تسجيل' onclick='' >
    ...
    while ($c<=20){
         ...
         print "<tr class='tr-row'>
            ...
            <input type='text' name='row".$c."' id='row".$c."' class='form-control col-sm-6 row-res ' autocomplete='off' value='".$row_lab['row'.$c]."' /> 
  ...
  for ($c_grop1=1 ;$c_grop1<=6;$c_grop1++){
      if ($c_grop1==5){
          print "<tr>
                    <td>
                        <input type='text' name='comment4a' id='comment4a' class='form-control  seltext' value='".$row_lab['Comment4a']."'/>
                    </td>
                </tr>";
      }elseif($c_grop1==6){
          print "<tr>
                    <td>
                        <input type='text' name='comment8a' id='comment8a' class='form-control  seltext' value='".$row_lab['Comment8a']."'/>
          ...
          print "<tr>
                    <td>
                        <input type='text'name='comment".$c_grop1."' id='comment".$c_grop1."' class='form-control  seltext' value='".$row_lab['Comment'.$c_grop1]."'/>
                    </td>
...
<div class='col-sm-1'> </div>
 ...
 for ($c_grop2=5 ;$c_grop2<=10;$c_grop2++){
      if ($c_grop2==9){
          print "<tr>
                    <td>
                        <input type='text' name='comment4b' id='comment4b' class='form-control  seltext' value='".$row_lab['Comment4b']."' />
          ...
          print "<tr>
                    <td>
                        <input type='text' name='comment8b' id='comment8b' class='form-control  seltext' value='".$row_lab['Comment8b']."'/>
          ...
          print "<tr>
                    <td>
                        <input type='text' name='comment".$c_grop2."' id='comment".$c_grop2."' class='form-control  seltext' 
                        value='".$row_lab['Comment'.$c_grop2]."'/>
...
for ($c_grop3=9 ;$c_grop3<=14;$c_grop3++){
      if ($c_grop3==13){
          print "<tr>
                    <td>
                        <input type='text' name='comment4c' id='comment4c' class='form-control  seltext' value='".$row_lab['Comment4c']."'/>
          ...
          print "<tr>
                    <td>
                        <input type='text' name='comment8c' id='comment8c' class='form-control  seltext' 
                        value='".$row_lab['Comment4c']."'/>
          ...
          print "<tr>
                    <td>
                        <input type='text' name='comment".$c_grop3."' id='comment".$c_grop3."' class='form-control  seltext' 
                        value='".$row_lab['Comment'.$c_grop3]."'/>
...
print "      </tbody>
        ...
        <div class='row'>
            <textarea rows='2' cols='100' class='t-area td-dir' align='center'  name='nb' id='nb'>".$row_lab['NB']."</textarea>
        </div>
  </div>
</form>";
        ...
        if(isset($_POST['nb']))
    {
        $_SESSION['nb'] = $_POST['nb']; 
         ...
         $sql1 = "UPDATE `seci`.`lab1_cbc` SET `row1`='".$_SESSION['row1']."', `row2`='".$_SESSION['row2']."', `row3`='".$_SESSION['row3']."', `row4`='".$_SESSION['row4']."', `row5`='".$_SESSION['row5']."', `row6`='".$_SESSION['row6']."', `row7`='".$_SESSION['row7']."', `row8`='".$_SESSION['row8']."', `row9`='".$_SESSION['row9']."', `row10`='".$_SESSION['row10']."', `row11`='".$_SESSION['row11']."', `row12`='".$_SESSION['row12']."', `row13`='".$_SESSION['row13']."', `row14`='".$_SESSION['row14']."', `row15`='".$_SESSION['row15']."', `row16`='".$_SESSION['row15']."', `row17`='".$_SESSION['row17']."', `row18`='".$_SESSION['row18']."', `row19`='".$_SESSION['row19']."', `row20`='".$_SESSION['row20']."', `NB`='".$_SESSION['nb']."', `Comment1`='".$_SESSION['comment1']."', `Comment2`='".$_SESSION['comment2']."', `Comment3`='".$_SESSION['comment3']."', `Comment4`='".$_SESSION['comment4']."', `Comment5`='".$_SESSION['comment5']."', `Comment6`='".$_SESSION['comment6']."', `Comment7`='".$_SESSION['comment7']."', `Comment8`='".$_SESSION['comment8']."', `Comment9`='".$_SESSION['comment9']."', `Comment10`='".$_SESSION['comment10']."', `Comment11`='".$_SESSION['comment11']."', `Comment12`='".$_SESSION['comment12']."', `Comment4a`='".$_SESSION['comment4a']."', `Comment8a`='".$_SESSION['comment8a']."', `Comment4b`='".$_SESSION['comment4b']."', `Comment8b`='".$_SESSION['comment8b']."', `Comment4c`='".$_SESSION['comment4c']."', `Comment8c`='".$_SESSION['comment4c']."' WHERE `Serial`='".$_SESSION['serial']."';";
