...
<link rel="stylesheet" href="css/men_internal_report.css"/>	
</head>
...
<body>
     ...
     <header class="head">
        ...
        <div class="div4" >
            ...
            <div class="div3">
          <h2 class="title"><span>تغذية مرضى قسم رجال (باطنة)</span></h2>
	...
	<form method="post">
		...
		if(isset($_SESSION['username']))
			...
			$row1=mysqli_fetch_assoc($queryResult1);
				  ...
				  if($row1[to_dept] == 15 && $row1[to_ward] == 1)
				  {
				  ...
				  else if ($row[ward] == 1 && $row[ademission_dept] == 15){
	...
	<script src="js/men_internal_report.js"></script>
</body>
</html>