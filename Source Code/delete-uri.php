...
<meta name="viewport" content="width=device-width, initial-scale=1"> 
    ...
    <title>Delete Report Urinalysis</title>  
    <!--[if lt IE 9]>
        ...
        <div class="container">
            ...
            <form id="form1" method="post" action="lab.php" class="b-space">
                <div class="row general_lab_title">
                        ...
                        <h1 class="col-sm-11 ">الغاء Urinalysis </h1>
                    
                </div>
                
            </form>
            
            <form id="form2" method="post" action="delete-uri.php"  >
                <div class="row">
...
{			
    ...
    if (isset($_POST['delete'])) { 
        ...
        print " <form id='form3' method='get' action='delete-uri.php' >        
                ...
                if($queryResult)
                {
                    ...
                    while($row=mysqli_fetch_assoc($queryResult)){
                        ...
                        <td align='center' >
                        <a  class='btn btn-outline-danger a-delete' role='button' href='delete-uri.php?serial=$row[Serial]' data-toggle='tooltip' title='حزف التقرير'>
  ...
  if(isset($_GET['serial'])){
        ...
        $de_sql= "DELETE FROM `seci`.`lab1_urinalysis` WHERE `Serial`='".$_GET['serial']."';";
