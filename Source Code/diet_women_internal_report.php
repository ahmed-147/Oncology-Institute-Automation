...
<link rel="stylesheet" href="css/women_internal_report.css"/>	
</head>
...
<body>
    ...
    <header class="head">
        ...
        <div class="div4" >
            ...
            <div class="div3">
          			<h2 class="title"><span>تغذية مرضى قسم نساء (باطنة)</span></h2>
	...
	<form method="post">
		...
		if(isset($_SESSION['username']))
			...
			$row1=mysqli_fetch_assoc($queryResult1);
				  ...
				  if($row1[to_dept] == 16 && $row1[to_ward] == 2)
				  {
				  ...
				  else if ($row[ward] == 2 && $row[ademission_dept] == 16){
	...
	<table border="3" rules="all" class="report_table">
		...
		<?php
			...
			$sql4 ="SELECT current_diet FROM `women_current diet` where patient_code = '" .$row1['patient_code']. "' "; ;
			...
			$sql9 ="SELECT current_diet FROM `women_current diet` where patient_code = '" .$row['patient_code']. "' "; ;
    ...
    ?>
		...
		<?php
			...
			$sql2 ="SELECT current_diet FROM `women_current diet` where patient_code = '" .$d1['patient_code']. "' "; ;
	...
	<script src="js/women_internal_report.js"></script>
</body>
</html>