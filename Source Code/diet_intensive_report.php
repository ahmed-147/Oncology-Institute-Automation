...
<link rel="stylesheet" href="css/diet_intensive_report.css"/>	
</head>
...
<body>
    ...
    <header class="head">
       ...
       <div class="div4" >
            ...
            <div class="div3">
          <h2 class="title"><span>تغذية مرضى قسم العناية المركزة</span></h2>
	...
	<table border="3" rules="all" class="report_table">
		...
		<?php
			...
			$sql4 ="SELECT current_diet FROM `icu_current diet` where patient_code = '" .$row1['patient_code']. "' "; ;
			...
			$sql9 ="SELECT current_diet FROM `icu_current diet` where patient_code = '" .$row['patient_code']. "' "; ;
    ...
    ?>
		...
		<?php
			...
			$sql2 ="SELECT current_diet FROM `icu_current diet` where patient_code = '" .$d1['patient_code']. "' "; ;
			...
			$sql3 ="SELECT current_diet FROM `icu_current diet` where patient_code = '" .$d['patient_code']. "' "; ;
	...
	<script src="js/diet_intensive_report.js"></script>
</body>
</html>