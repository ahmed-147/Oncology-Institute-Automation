...
<meta name="viewport" content="width=device-width, initial-scale=1"> 
    ...
    <link rel="stylesheet" href="css/edit-f-styles/porth-edit-style.css"/>
    ...
    <title>Porthrombin Reports </title>  
    <!--[if lt IE 9]>
        ...
        <div class="container">
            ...
            <form id="form1" method="post" action="lab.php" class="b-space">
                <div class="row general_lab_title">
                        ...
                        <h1 class="col-sm-11 ">تعديل و تسجيل Porthrombin</h1>
                    
                </div>
                
            </form>
            
            <form id="form2" method="post" action="d-r-porth.php" >
                <div class="row">
...
{			
    ...
    if (isset($_POST['edit'])) { 
        ...
        print " <form id='form3' method='get' >        
                ...
                $sql="SELECT * FROM seci.lab1_prothrombin where patient_code ='" . $_POST['patient_code']. "' ";
                ...
                if($queryResult)
                {
                    ...
                    while($row=mysqli_fetch_assoc($queryResult)){
                        ...
                        <td align='center' >
                         <a  class='btn btn-primary' role='button' href='porth-form.php?serial=$row[Serial]'><span class='glyphicon glyphicon-open-file' ></span></a>
                        </td>
                        </tr>";
    ...
    if (isset($_POST['view'])) { 
                ...
                $sql4="SELECT * FROM seci.lab1_prothrombin  where patient_code ='" . $_POST['patient_code']. "' ";
               ...
               //---------  Category='1'  uint and contral------//  
                ...
                $sql2="SELECT * FROM seci.lab1_prothrombin_normals where Category='5'";
                ...
                $sql3="SELECT * FROM seci.lab1_prothrombin_normals where Category='4'";
...
print "
    <form class='porth_form' method='post' action ='d-r-porth.php'>
        
        <div class='row b-space'>
            <h1 align='center' class='col-sm-12 '> تسجيل Porthrombin</h1>
        </div>
    ...
    <!----------------------- -:(patient date):- ------------------------->
        ...
        <div class='row'>
            ...
            <table border='3' rules='all' class='porth_table txt-dir'>

            <thead>
                 <div>
                    <th align='center' class=' col-sm-4'></th>
                    <th align='center' class=' col-sm-4' style='text-align:center'><label>Patient</label></th>
                    <th align='center' class=' col-sm-4' style='text-align:center'><label>Control</label></th> 
                 </div>
            </thead>
    ...
    while ($c<=8){
     ...
     if ($c == 1||$c == 3||$c == 5||$c == 7){
         print "<tr class='txt-dir'>
                     <div>
                        <th class='txt-dir'><label> $titles[$c]</label></th>
                        ...
                        <div>
                            ...
                            <td align='center' class='txt-dir'>".$row_uint[($c +1)]."</td>
                    </div>
                </tr>";
        }
    $c++;
...
if(isset($_POST['insert'])){
    ...
    <script src="js/edit-js/porth-edit-js.js"></script>
