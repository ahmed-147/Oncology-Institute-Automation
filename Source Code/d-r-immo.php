...
<meta name="viewport" content="width=device-width, initial-scale=1"> 
    ...
    <link rel="stylesheet" href="css/enter-f-style/immo-form-style.css"/>
    ...
    <title>Immunology Reports </title>  
    <!--[if lt IE 9]>
        ...
        <div class="container">
            ...
            <form id="form1" method="post" action="lab.php" class="b-space">
                <div class="row general_lab_title">
                        ...
                        <h1 class="col-sm-11 ">تعديل و تسجيل Immunology </h1>
                    
                </div>
                
            </form>
            
            <form id="form2" method="post" action="d-r-immo.php" >
                <div class="row">
...
{			
    ...
    if (isset($_POST['edit'])) { 
        ...
        print " <form id='form3' method='get' >        
                ...
                $sql="SELECT * FROM seci.lab1_immunology where patient_code ='" . $_POST['patient_code']. "' ";
                ...
                if($queryResult)
                {
                    ...
                    while($row=mysqli_fetch_assoc($queryResult)){
                        ...
                        <td align='center' >
                         <a  class='btn btn-primary' role='button' href='immo-form.php?serial=$row[Serial]'><span class='glyphicon glyphicon-open-file' ></span></a>
                        </td>
                        </tr>";
   ...
   if (isset($_POST['view'])) { 
                ...
                $sql4="SELECT * FROM seci.lab1_immunology  where patient_code ='" . $_POST['patient_code']. "' ";
...
print "
    <form class='immo_form' method='post' action ='d-r-immo.php'>
            ...
            <div class='row b-space'>
                <h1 align='center' class='col-sm-12 '> تسجيل Immunology </h1>
            </div>
    <!----------------------- -:(patient date):- ------------------------->
            ...
            <div class='txt-dir col-sm-8'>
                <div class='row '>
                    ...
                    <div class='col-sm-4 txt-dir' >
                        <select name='specimen' id='specimen' class='form-control txt-dir sel'>
                     		<option value=''></option>
...
if(isset($_POST['insert'])){
 ...
 $sql8 = "INSERT INTO `seci`.`lab1_immunology` (`patient_code`, `Header`, `Lab_number`, `Specimen_date`, `Report_date`, `Specimen`, `row1`, `unit1`, `n_row1`, `row2`, `unit2`, `n_row2`, `row3`, `unit3`, `n_row3`) VALUES ('". $_SESSION['patient_code']."', '".$_SESSION['r_header']."', '".$_SESSION['lab_num']."', '".$_SESSION['specimen_d']."', '".$_SESSION['report_d']."', '". $_SESSION['specimen']."', '".$_SESSION['row1']."', 'IU/ml', '< 200 IU/ml', '".$_SESSION['row2']."', 'mg/dl', '< 6 mg/dl', '".$_SESSION['row3']."', 'IU/ml', '< 8 IU/ml');";
    ...
    <script src="js/edit-js/immo-edit-js.js"></script>
