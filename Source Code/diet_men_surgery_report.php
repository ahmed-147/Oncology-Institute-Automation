...
<link rel="stylesheet" href="css/men_surgery_report.css"/>	
</head>
...
<body>
    ...
    <header class="head">
           <div class="div4" >
            ...
            <div class="div3">
          		<h2 class="title"><span>تغذية مرضى قسم رجال (جراحة)</span></h2>
	...
	<form method="post">
		...
		if(isset($_SESSION['username']))
			...
			$row1=mysqli_fetch_assoc($queryResult1);
				  ...
				  if($row1[to_dept] == 1 && $row1[to_ward] == 1)
				  {
				  ...
				  else if ($row[ward] == 1 && $row[ademission_dept] == 1){
	...
	<table border="3" rules="all" class="report_table">
		...
		<?php
			...
			$sql4 ="SELECT current_diet FROM `men_current diet` where patient_code = '" .$row1['patient_code']. "' "; ;
			...
			$sql9 ="SELECT current_diet FROM `men_current diet` where patient_code = '" .$row['patient_code']. "' "; ;
    ...
    ?>
		...
		<?php
            ...
            {	
				...
				if ($d4[code] == 0 && $men_diet0 > 0)
				 { 
				print "<tr><td align='center'>$d4[text]</td><td align='center'>$men_diet0</tD></tr>";
					}
				  
				if ($d4[code] == 1 && $men_diet1 > 0)
				 { 
				print "<tr><td align='center'>$d4[text]</td><td align='center'>$men_diet1</tD></tr>";
					}
				  
				if ($d4[code] == 2 && $men_diet2 > 0)
				 { 
				print "<tr><td align='center'>$d4[text]</td><td align='center'>$men_diet2</tD></tr>";
					}
				
				if ($d4[code] == 3 && $men_diet3 > 0)
				 { 
				print "<tr><td align='center'>$d4[text]</td><td align='center'>$men_diet3</tD></tr>";
					}
				  
				if ($d4[code] == 4 && $men_diet4 > 0)
				 { 
				print "<tr><td align='center'>$d4[text]</td><td align='center'>$men_diet4</tD></tr>";
					}
				  
				if ($d4[code] == 5 && $men_diet5 > 0)
				 { 
				print "<tr><td align='center'>$d4[text]</td><td align='center'>$men_diet5</tD></tr>";
					}
				  
				if ($d4[code] == 6 && $men_diet6 > 0)
				 { 
				print "<tr><td align='center'>$d4[text]</td><td align='center'>$men_diet6</tD></tr>";
					}
				
			  }
			}
				
				$total = $men_diet0 + $men_diet1 + $men_diet2 + $men_diet3
					+ $men_diet4 + $men_diet5 + $men_diet6 ;
	...
	<script src="js/men_surgery_report.js"></script>
</body>
</html>