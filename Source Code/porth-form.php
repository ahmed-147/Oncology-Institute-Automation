...
<meta name="viewport" content="width=device-width, initial-scale=1"> 
    ...
    <body>
        <div class="container g">
            ...
            <form id="form1" method="post" action="d-r-porth.php">
                <div class="row ">
                    ...
                    <div class="col-sm-1">
                        ...
                        <h1 class="col-sm-11 general_lab_title" >تعديل Porthrombin</h1>
                </div>
...
{	
    ...
    //------------- view button -----------------//
                ...
                $sql4="SELECT * FROM seci.lab1_prothrombin  where Serial ='" .$_SESSION['serial']. "' ";
...
if(isset($_POST['insert'])){
        ...
        if(isset($_POST['nb']))
    {
        $_SESSION['nb'] = $_POST['nb']; 
         ...
         $sql1 = "UPDATE `seci`.`lab1_prothrombin` SET `Lab_number`='".$_SESSION['lab_num']."', `Specimen_date`='".$_SESSION['specimen_d']."', `Report_date`='".$_SESSION['report_d']."', `row1`='".$_SESSION['row1']."', `row2`='".$_SESSION['row2']."', `row3`='".$_SESSION['row3']."', `row4`='".$_SESSION['row4']."', `row7`='".$_SESSION['row7']."' WHERE `Serial`='".$_SESSION['serial']."'";
