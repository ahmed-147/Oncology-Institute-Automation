...
<meta name="viewport" content="width=device-width, initial-scale=1"> 
    ...
    <link rel="stylesheet" href="css/edit-f-styles/cs-edit-style.css"/>
    <link rel="stylesheet" href="css/edit-f-styles/d-report-style.css"/>
    
   
    <title>Edit Results cs</title>  
    <!--[if lt IE 9]>
    ...
    <body>
        <div class="container g">
            ...
            <form id="form1" method="post" action="d-r-cs.php">
                <div class="row ">
                    <div class="col-sm-1">
                        ...
                        <h1 class="col-sm-11 general_lab_title">تعديل CS</h1>
                </div>
...
{	
    ...
    //------------- view button -----------------//
                ...
                $sql4="SELECT * FROM seci.lab1_cs  where Serial ='" . $_SESSION['serial']. "' ";
...
print "
    <form class='cs_form' method='post' action ='cs-form.php'>
            ...
            <div class='txt-dir col-sm-8'>
                <div class='row '>
                    ...
                    <div class='col-sm-4 txt-dir' >
                        <input type='text' name='specimen' id='specimen' class='txt-dir form-control' autocomplete='off' value='".$row_lab['Specimen']."'/>
                    </div>
...
<div class='row  b-space'>
            ...
            <div class='txt-dir col-sm-8'>
                <div class='row '>
                    ...
                    <div class='col-sm-4 txt-dir' >
                        <input type='text' name='organism' id='organism' class='txt-dir form-control' autocomplete='off' value='".$row_lab['Organism']."' />
                    </div>
                    <div class='col-sm-5'></div>
                </div>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row1a' id='row1a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row1a']."'/> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row1b' id='row1b' class='txt-dir col-sm-6 form-control' autocomplete='off'  value='".$row_lab['row1b']."'/> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row2a' id='row2a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row2a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row2b' id='row2b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row2b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row3a' id='row3a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row3a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row3b' id='row3b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row3b']."' /> 
                    </div>
                </div>
            </td>
    ...
    <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row4a' id='row4a' class='txt-dir  col-sm-6 form-control' autocomplete='off'  value='".$row_lab['row4a']."'/> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row4b' id='row4b' class='txt-dir col-sm-6 form-control' autocomplete='off'  value='".$row_lab['row4b']."'/> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row5a' id='row5a' class='txt-dir  col-sm-6 form-control' autocomplete='off'  value='".$row_lab['row5a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row5b' id='row5b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row5b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row6a' id='row6a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row6a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row6b' id='row6b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row6b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row7a' id='row7a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row7a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row7b' id='row7b' class='txt-dir col-sm-6 form-control' autocomplete='off'value='".$row_lab['row7b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row8a' id='row8a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row8a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row8b' id='row8b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row8b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row9a' id='row9a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row9a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row9b' id='row9b' class='txt-dir col-sm-6 form-control' autocomplete='off'value='".$row_lab['row9b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row10a' id='row10a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row10a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row10b' id='row10b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row10b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row11a' id='row11a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row11a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row11b' id='row11b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row11b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row12a' id='row12a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row12a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row12b' id='row12b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row12b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row13a' id='row13a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row13a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row13b' id='row13b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row13b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row14a' id='row14a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row14a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row14b' id='row14b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row14b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row15a' id='row15a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row15a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row15b' id='row15b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row15b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row16a' id='row16a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row16a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row16b' id='row16b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row16b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row17a' id='row17a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row17a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row17b' id='row17b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row17b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row18a' id='row18a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row18a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row18b' id='row18b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row18b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row19a' id='row19a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row19a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row19b' id='row19b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row19b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row20a' id='row20a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row20a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row20b' id='row20b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row20b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row21a' id='row21a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row21a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row21b' id='row21b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row21b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row22a' id='row22a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row22a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row22b' id='row22b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row22b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row23a' id='row23a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row23a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row31a' id='row31a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row31a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row31b' id='row31b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row31b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row32a' id='row32a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row32a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row32b' id='row32b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row32b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row33a' id='row33a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row33a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row33b' id='row33b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row33b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row34a' id='row34a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row34a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row34b' id='row34b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row34b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row35a' id='row35a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row35a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row35b' id='row35b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row35b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row36a' id='row36a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row36a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row36b' id='row36b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row36b']."' /> 
                    </div>
                </div>
            </td>
      ...
      <tr class=' row tr-row'>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row37a' id='row37a' class='txt-dir  col-sm-6 form-control' autocomplete='off' value='".$row_lab['row37a']."' /> 
                    </div>
                </div>
            </td>
            <td class='col-sm-6' >
                <div class='row txt-dir'>
                    ...
                    <div class='col-sm-6 txt-dir'>
                        <input type='text' name='row37b' id='row37b' class='txt-dir col-sm-6 form-control' autocomplete='off' value='".$row_lab['row37b']."' /> 
                    </div>
                </div>
            </td>
...
if(isset($_POST['insert'])){
    ...
    <script src="js/but-forms-res-action.js"></script>
