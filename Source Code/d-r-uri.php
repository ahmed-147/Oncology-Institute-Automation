...
<meta name="viewport" content="width=device-width, initial-scale=1"> 
    ...
    <title>Urinalysis Reports </title>  
    <!--[if lt IE 9]>
        ...
        <div class="container">
            ...
            <form id="form1" method="post" action="lab.php" class="b-space">
                <div class="row general_lab_title">
                        ...
                        <h1 class="col-sm-11 ">تعديل و تسجيل Urinalysis </h1>
                    
                </div>
                
            </form>
            
            <form id="form2" method="post" action="d-r-uri.php" >
                <div class="row">
...
{			
    ...
    if (isset($_POST['edit'])) { 
        ...
        print " <form id='form3' method='get' >        
                ...
                $sql="SELECT * FROM seci.lab1_urinalysis where patient_code ='" . $_POST['patient_code']. "' ";
                ...
                if($queryResult)
                {
                    ...
                    while($row=mysqli_fetch_assoc($queryResult)){
                        ...
                        <td align='center' >
                         <a  class='btn btn-primary' role='button' href='uri-form.php?serial=$row[Serial]'><span class='glyphicon glyphicon-open-file' ></span></a>
                        </td>
                        </tr>";
...
if (isset($_POST['view'])){
    ...
    $sql1="SELECT * FROM seci.lab1_urinalysis where patient_code ='" . $_POST['patient_code']. "' ";
    ...
    print "
    <form class='uri_form' method='post'  action='d-r-uri.php'>
    <div class='row b-space'>
            <h1 align = 'center' class='col-sm-11 '> تسجيل Urinalysis </h1>
    </div>
    <!----------------------- -:(patient date):- ------------------------->
                ...
                <tr class='txt-dir tr-row'>
                    ...
                    <td class='txt-dir td-w5 '>
                        <div class='row'>
                            ...
                            <input type='text' name='row2' id='row2' class='txt-dir col-sm-6 inp-size-t form-control' autocomplete='off' />
                        </div>
                    </td>
                ...
                <tr class='txt-dir tr-row'>
                    ...
                    <td class='txt-dir td-w5'>
                        <div class='row'>
                            ...
                            <input type='text' name='row4' id='row4' class='txt-dir col-sm-6 inp-size-t form-control' autocomplete='off' />
                        </div>
                    </td>
                </tr>
                <tr class='tr-row'>
                ...
                <tr class='txt-dir tr-row'>
                    ...
                    <td class='txt-dir td-w5'>
                        <div class='row'>
                            ...
                            <input type='text' name='row6' id='row6' class='txt-dir col-sm-8 inp-size-t form-control' autocomplete='off' />
                        </div>
                    </td>
                    ...
                    <td class='txt-dir td-w5'>
                        <div class='row'>
                            ...
                            <input type='text' name='row7' id='row7' class='txt-dir col-sm-6 inp-size-t form-control' autocomplete='off' />
                        </div>
                    </td>
                ...
                <tr class='txt-dir tr-row'>
                    ...
                    <td class='txt-dir td-w5'> 
                        <div class='row'>
                            ...
                            <input type='text' name='row8' id='row8' class='txt-dir col-sm-8 inp-size-t form-control' autocomplete='off' />
                        </div>
                    </td>
                    <td  class='txt-dir'>
                        <div class='row'>
                            <label class='txt-dir col-sm-6' >&nbsp;Acetone:</label>
                            <input type='text' name='row9' id='row9' class='txt-dir col-sm-6 inp-size-t form-control' autocomplete='off' />
                        </div>
                    </td>
                </tr>
                ...
                <tr class='txt-dir tr-row'>
                    ...
                    <td class='txt-dir td-w5'> 
                        <div class='row'>
                            ...
                            <input type='text' name='row10' id='row10' class='txt-dir col-sm-8 inp-size-t form-control' autocomplete='off' />
                        </div>
                    </td>
                    <td  class='txt-dir'>
                        <div class='row'>
                            <label class='txt-dir col-sm-6' >&nbsp;Leukocytes:</label>
                            <input type='text' name='row11' id='row11' class='txt-dir col-sm-6 inp-size-t form-control' autocomplete='off' />
                        </div>
                    </td>
                </tr>
                ...
                <tr class='txt-dir tr-row'>
                    ...
                    <td class='txt-dir td-w5'> 
                        <div class='row'>
                            ...
                            <input type='text' name='row12' id='row12' class='txt-dir col-sm-8 inp-size-t form-control' autocomplete='off' />
                        </div>
                    </td>
                    ...
                    <td class='txt-dir'>
                        <div class='row'>
                            ...
                            <input type='text' name='row13' id='row13' class='txt-dir col-sm-6 inp-size-t form-control' autocomplete='off' />
                        </div>
                    </td>
                </tr>
                ...
                <tr class='tr-row' colspan='2'>
                    ...
                    <td class='txt-dir' colspan='2'>
                         <div class='row'>
                            ...
                            <input type='text' name='row14' id='row14' class='col-sm-6 txt-dir inp-size-t form-control' autocomplete='off' />
                ...
                <tr class='tr-row' colspan='2'>
                    ...
                    <td class='txt-dir' colspan='2'>
                         <div class='row'>
                            ...
                            <input type='text' name='row15' id='row15' class='col-sm-6 txt-dir inp-size-t form-control' autocomplete='off' />
                ...
                <tr class='tr-row' colspan='2'>
                    ...
                    <td class='txt-dir' colspan='2'>
                         <div class='row'>
                            ...
                            <input type='text' name='row16' id='row16' class='col-sm-6 txt-dir inp-size-t form-control' autocomplete='off' />
                ...
                <tr class='tr-row' colspan='2'>
                    ...
                    <td class='txt-dir' colspan='2'>
                         <div class='row'>
                            ...
                            <input type='text' name='row17' id='row17' class='col-sm-8 txt-dir inp-size-t form-control' autocomplete='off' />
                ...
                <tr class='tr-row' colspan='2'>
                    ...
                    <td class='txt-dir' colspan='2'>
                         <div class='row'>
                            ...
                            <input type='text' name='row18' id='row18' class='col-sm-8 txt-dir inp-size-t form-control' autocomplete='off' />
                ...
                <tr class='tr-row' colspan='2'>
                    ...
                    <td class='txt-dir' colspan='2'>
                         <div class='row'>
                            ...
                            <input type='text' name='row19' id='row19' class='col-sm-8 txt-dir inp-size-t form-control' autocomplete='off' />
                ...
                <tr class='tr-row' colspan='2'>
                    ...
                    <td class='txt-dir' colspan='2'>
                         <div class='row'>
                            ...
                            <input type='text' name='row20' id='row20' class='col-sm-8 txt-dir inp-size-t form-control' autocomplete='off' />
                ...
                <tr class='tr-row' colspan='2'>
                    ...
                    <td class='txt-dir' colspan='2'>
                         <div class='row'>
                            ...
                            <input type='text' name='row21' id='row21' class='col-sm-8 txt-dir inp-size-t form-control' autocomplete='off' />
...
if(isset($_POST['insert'])){
        ...
        if(isset($_POST['nb']))
        {
         ...
         $sqlins = "INSERT INTO `seci`.`lab1_urinalysis` (`patient_code`, `Header`, `Lab_number`, `Specimen_date`, `Report_date`, `row1`, `row2`, `row3`, `row4`, `row5`, `row6`, `row7`, `row8`, `row9`, `row10`, `row11`, `row12`, `row13`, `row14`, `row15`, `row16`, `row17`, `row18`, `row19`, `row20`, `row21`, `NB`) VALUES ('". $_SESSION['patient_code']."', '".$_SESSION['r_header']."', '".$_SESSION['lab_num']."', '".$_SESSION['sample_d']."', '".$_SESSION['report_d']."', '".$_SESSION['row1']."', '".$_SESSION['row2']."', '".$_SESSION['row3']."', '".$_SESSION['row4']."', '".$_SESSION['row5']."', '".$_SESSION['row6']."', '".$_SESSION['row7']."', '".$_SESSION['row8']."', '".$_SESSION['row9']."', '".$_SESSION['row10']."', '".$_SESSION['row11']."', '".$_SESSION['row12']."', '".$_SESSION['row13']."', '".$_SESSION['row14']."',  '".$_SESSION['row15']."', '".$_SESSION['row16']."', '".$_SESSION['row17']."', '".$_SESSION['row18']."', '".$_SESSION['row19']."','".$_SESSION['row20']."', '".$_SESSION['row21']."','".$_SESSION['nb']."');";
 ...
 /*           echo "<div class='insert_dialoge' id='dialog-message' title='اضافة تقرير'>
    ...
    <script src="js/edit-js/uri-edit-js.js"></script>
